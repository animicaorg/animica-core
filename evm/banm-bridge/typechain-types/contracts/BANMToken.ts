...
export interface BANMTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BURNER_ROLE"
      | "DEFAULT_ADMIN_ROLE"
...
export namespace BurnExecutedEvent {
  ...
  export type OutputTuple = [orderId: string, account: string, amount: bigint];
  export interface OutputObject {
    orderId: string;
    account: string;
    amount: bigint;
...
export namespace MintExecutedEvent {
  ...
  export type OutputTuple = [orderId: string, to: string, amount: bigint];
  export interface OutputObject {
    orderId: string;
    to: string;
    amount: bigint;
...
export interface BANMToken extends BaseContract {
  connect(runner?: ContractRunner | null): BANMToken;
  waitForDeployment(): Promise<this>;

  interface: BANMTokenInterface;
  ...
  mint: TypedContractMethod<
    [to: AddressLike, amount: BigNumberish, orderId: BytesLike],
    [void],
    "nonpayable"
  >;
  ...
  filters: {
    ...
    "MintExecuted(bytes32,address,uint256)": TypedContractEvent<
      MintExecutedEvent.InputTuple,
      MintExecutedEvent.OutputTuple,
      MintExecutedEvent.OutputObject
    >;
