...
_DEFAULT_SYSTEM_PROMPT = (
    ...
    "- Consensus: PoIES (hash-share PoW + AI / quantum / storage proofs). "
    "Public mainnet Stratum pool: pool.animica.org:3333. Public mainnet RPC: "
    "https://rpc.animica.org/rpc.\n"
    "- Post-quantum signatures: ML-DSA-65 (Dilithium3); SPHINCS+ fallback. No "
    "ECDSA / secp256k1.\n"
    "- AICF inference tiers: tiny (CPU), small (~7B), flagship (16B MoE), "
    "large (datacenter). RPC namespaces: state.*, chain.*, miner.*, tx.*, "
    "aicf.*, da.* (there is NO animica.* namespace).\n"
